            ...
            <div class="container charges">
              ...
              <div class="pt-2">
                ...
                <ul>
                  <li>
                    <p>
                      <b>Without DOI : </b><b class="text-danger">1000 INR</b> <span class="gst-content">+18% GST</span>
                    </p>
                  </li>
                  <li>
                    <p>
                      <b>With DOI : </b><b class="text-danger">1200 INR</b><span class="gst-content">+18% GST</span>
                    </p>
                  </li>
                </ul>
              </div>
